...
<a href="create.php" class="btn btn-big">Add F.A.Q</a>
<a href="index.php" class="btn btn-big"> Manage F.A.Q</a>
    </div>

    <div class="content">
        <h2 class="page-title"><b> Add F.A.Q category</b></h2>
...
<div>
    ...
    <div>
<button type="submit" name="add-frequent" class="btn btn-big"> Add Category </button>
 </div>
</form>
