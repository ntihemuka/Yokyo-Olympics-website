...
<a href="create.php" class="btn btn-big">Edit Activities</a>
<a href="index.php" class="btn btn-big">Manage Activities</a>
    </div>

    <div class="content">
        <h2 class="page-title"><b> Edit Activities</b></h2>
...
<div>
          ...
          <input type="datetime-local" name="slot"  > <br> <br> Activity is currently set for  : <?php echo date ('F j, Y, G:iA', strtotime($slot)); ?>
</div> 
<div>
<div>
          <label> Body </label>
...
<div>
    <button type="submit" name="update-activity" class="btn btn-big">Update Activity </button>
</div>
