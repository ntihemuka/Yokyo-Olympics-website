...
<a href="create.php" class="btn btn-big">Edit Videos</a>
<a href="index.php" class="btn btn-big"> Manage Videos</a>
    </div>

    <div class="content">
        <h2 class="page-title"><b> Edit Videos</b></h2>
...
<div>
<labe> Video</label>
<input type="file" name="file" class="text-inpput">
</div>
...
<div>
    <button type="submit" name="update-video" class="btn btn-big">Update Video </button>
</div>
